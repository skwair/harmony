...
// HasPermission returns whether the given permission is set in permissions.
func HasPermission(permissions, permission int) bool {
	return permissions&permission == permission
}

// ComputePermissions returns the permissions of a guild member in a given guild and
// channel combination.
// This method uses the algorithm described here :
// https://discordapp.com/developers/docs/topics/permissions#permission-overwrites
func ComputePermissions(g *Guild, ch *Channel, m *GuildMember) (permissions int) {
...
func computeBasePermissions(g *Guild, m *GuildMember) (permissions int) {
	...
	if HasPermission(permissions, PermissionAdministrator) {
		return PermissionAll
	}
	return permissions
}
...
func computeOverwrites(ch *Channel, m *GuildMember, basePermissions int) (permissions int) {
	// PermissionAdministrator can not be overidden.
